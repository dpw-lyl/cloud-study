...
-- 三级菜单
insert into sys_menu values('500',  '操作日志', '108', '1', 'OperationLog',    'system/OperationLog/index',    '', 1, 0, 'C', '0', '0', 'system:OperationLog:list',    'form',          'admin', sysdate(), '', null, '操作日志菜单');
insert into sys_menu values('501',  '登录日志', '108', '2', 'LoginInfo', 'system/LoginInfo/index', '', 1, 0, 'C', '0', '0', 'system:LoginInfo:list', 'LoginInfo',    'admin', sysdate(), '', null, '登录日志菜单');
-- 用户管理按钮
...
-- 操作日志按钮
insert into sys_menu values('1039', '操作查询', '500', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:OperationLog:query',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1040', '操作删除', '500', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:OperationLog:remove',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1041', '日志导出', '500', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:OperationLog:export',      '#', 'admin', sysdate(), '', null, '');
-- 登录日志按钮
insert into sys_menu values('1042', '登录查询', '501', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:LoginInfo:query',    '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1043', '登录删除', '501', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:LoginInfo:remove',   '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1044', '日志导出', '501', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:LoginInfo:export',   '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1045', '账户解锁', '501', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:LoginInfo:unlock',   '#', 'admin', sysdate(), '', null, '');
-- 在线用户按钮
