...
;
import com.dpw.lyl.join.good.job.iot.redis.netty.client.ImNettyClient;
...
public class ImNettyClientHeartBeatHandler extends NettyClientHeartBeatBaseHandler {
        ...
        if (evt instanceof IdleStateEvent) {
            ...
            switch (idleStateEvent.state()) {
                ...
                case ALL_IDLE:
                    break;
                case WRITER_IDLE:
                    eventType = ImNettyEventType.WRITER_IDLE;
                    timer.increment();
            ...
            if (timer.intValue() > nettyHeartBeat.getClientWriterThreshold()) {
                ...
                jsonObject.put("code", ImNettyCodeEnum.NETTY_CLIENT_HEART_MSG.getNettyCode());
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        eventExecutors.schedule(() -> imNettyClient.initClient(), nettyHeartBeat.getClientDelay(), TimeUnit.SECONDS);
