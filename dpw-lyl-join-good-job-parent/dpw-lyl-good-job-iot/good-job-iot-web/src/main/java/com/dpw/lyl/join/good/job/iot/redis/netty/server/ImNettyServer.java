...
import com.dpw.lyl.join.good.job.iot.redis.netty.handler.ImNettyServerChannelInitializer;
...
public class ImNettyServer {
    ...
    @Autowired
    @Qualifier("imnNettyServerChannelInitializer")
    private ImNettyServerChannelInitializer nettyServerChannelInitializer;
