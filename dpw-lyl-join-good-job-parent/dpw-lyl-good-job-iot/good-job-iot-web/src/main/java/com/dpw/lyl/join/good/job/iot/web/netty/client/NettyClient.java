...
public class NettyClient {
    ...
    public <T> T getRemoteProxyObject(final Class<?> serviceInterface){
        return (T) Proxy.newProxyInstance(serviceInterface.getClassLoader(),new Class<?>[]{serviceInterface},new DynProxy(serviceInterface,channel, nettyClientTemplate));
    }
    ...
    private static class DynProxy implements InvocationHandler {
        ...
        public DynProxy(Class<?> serviceInterface, Channel channel, NettyClientTemplate nettyClientTemplate){
            this.serviceInterface=serviceInterface;
            this.nettyClientTemplate=nettyClientTemplate;
