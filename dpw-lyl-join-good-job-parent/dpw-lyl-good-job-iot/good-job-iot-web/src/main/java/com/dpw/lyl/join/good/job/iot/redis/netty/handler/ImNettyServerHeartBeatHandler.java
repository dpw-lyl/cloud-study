...
public class ImNettyServerHeartBeatHandler extends NettyServerBaseHandler {
        ...
        if (evt instanceof IdleStateEvent) {
            ...
            switch (idleStateEvent.state()) {
                case READER_IDLE:
                    ...
                    jsonObject.put("nettyCode", ImNettyCodeEnum.NETTY_SERVER_HEART_MSG.getNettyCode());
                    jsonObject.put("nettyMsg",ImNettyCodeEnum.NETTY_SERVER_HEART_MSG.getNettyMsg());
            ...
            if (timer.intValue() > 3) {
                ...
                jsonObject.put("nettyCode", ImNettyCodeEnum.NETTY_SERVER_HEART_MSG_CLOSE.getNettyCode());
                jsonObject.put("nettyMsg",ImNettyCodeEnum.NETTY_SERVER_HEART_MSG_CLOSE.getNettyMsg());
