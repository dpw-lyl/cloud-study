...
import com.dpw.lyl.join.good.job.iot.redis.netty.constant.ImNettyCodeEnum;
...
import com.dpw.lyl.join.good.job.iot.redis.netty.template.ImNettyClientTemplate;
...
@Order(1)
public class ImNettyClientHandler extends NettyClientBaseHandler {

    @Resource
    private ImNettyClientTemplate imNettyClientTemplate;
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        jsonObject.put("code", ImNettyCodeEnum.NETTY_CLIENT_HEART_MSG_CLOSE.getNettyCode());
        jsonObject.put("data", ImNettyCodeEnum.NETTY_CLIENT_HEART_MSG_CLOSE.getNettyMsg());
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        ...
        imNettyClientTemplate.deleteServerChannel(redisService.getCacheObject(ctx.channel().id().asLongText()));
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        if (cacheObject instanceof String) {
            imNettyClientTemplate.deleteServerChannel((String) cacheObject);
        }
        redisService.deleteObject(ctx.channel().id().asLongText());
    }
