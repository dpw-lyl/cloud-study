...
import com.dpw.lyl.join.good.job.iot.redis.netty.handler.ImClientChannelInitializer;
...
public class ImNettyClient {
    ...
    @Resource
    private ImClientChannelInitializer imClientChannelInitializer;
    ...
    public void startNettyClient() {
        ...
        bootstrap.group(eventLoopGroup)     // 设置客户端的线程池
                ...
                .handler(imClientChannelInitializer // 设置客户端的线程池对应的 NioEventLoop 设置对应的事件处理器
                );
